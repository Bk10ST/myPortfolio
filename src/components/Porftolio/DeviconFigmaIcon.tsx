...
const DeviconFigmaIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 128 128' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <g clipPath='url(#clip0_23_133)'>
      <path
...
const Memo = memo(DeviconFigmaIcon);
export { Memo as DeviconFigmaIcon };
